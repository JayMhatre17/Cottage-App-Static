...
const Home = () => {
	return (
		<div
			className="font-bold bg-repeat-y w-screen sm:bg-cover bg-blend-darken contrast-100"
			style={{ backgroundImage: `url("../images/beah.jpg")` }}
		>
			<div className=" h-48 2xl:h-96 sm:h-screen brightness-100 ">
				...
				<div className="w-full pr-4 pl-4 lg:p-6">
					<div className="m-10 sm:m-20 h-96 pt-10 border-slate-500">
						...
						<div className="text-justify mt-5 pt-5 h-48 w-70 font-robo">
							...
							<li>We have both AC and Non AC Rooms Available.</li>
						</div>
					</div>
				</div>
			</div>
